...
<div class="row my-2">
    <div class="col-12 d-flex justify-content-between">
        <h3>Teachers</h3>
        <a href="{{ route('admin.teachers.create') }}" class="btn btn-dark d-none d-sm-inline-block">
         + Add New Teacher
        </a>
    </div>
</div>
                ...
                <tbody>
                    ...
                    @foreach ($teachers as $item)
                        <tr>
                            ...
                            <td>
                                @foreach ($item->classrooms as $subItem)
                                    <span class="badge bg-dark">{{$subItem->name}}</span>
                                @endforeach
                            </td>
                        
                        
                            <td>
                                <a href="{{route('admin.teachers.edit',$item->id)}}" class="btn btn-success btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>                        </a>
        ...
        $('.btn-delete').click(function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '/admin/teachers/' + materialId, // Adjust the route to your delete route
                        type: 'DELETE',
                        data: {
