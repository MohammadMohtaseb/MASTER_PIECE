                ...
                <tbody>
                    ...
                    @foreach ($Parents as $item)
                        <tr>
                            ...
                            <td>{{ $item->email }}</td>
                            <td>
                                <a href="{{route('admin.parents.edit',$item->id)}}" class="btn btn-success btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>                        </a>
        ...
        $('.btn-delete').click(function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '/admin/parents/' + materialId, // Adjust the route to your delete route
                        type: 'DELETE',
                        data: {
