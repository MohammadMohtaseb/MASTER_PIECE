...
@section('content')
    <div class="row my-2">
        <div class="col-12 d-flex justify-content-between">
            <h3>Stages</h3>
            <a href="{{ route('admin.stages.create') }}" class="btn btn-dark d-none d-sm-inline-block">
                + Add New Stage
            </a>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">All Stages</h5>
                ...
                <tbody>
                    ...
                    @forelse ($Stages as $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.stages.edit', $item->id) }}" class="btn btn-success btn-sm"><i
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="text-danger fw-bold text-center">DONT FOUND ANY DATA</td>
                        </tr>
                    @endforelse
